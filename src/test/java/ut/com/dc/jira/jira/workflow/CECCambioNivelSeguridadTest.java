...
import com.dc.jira.jira.workflow.CECCambioNivelSeguridad;

public class CECCambioNivelSeguridadTest
{
    public static final String MESSAGE = "my message";

    protected CECCambioNivelSeguridad function;
    ...
    public void setup() {
        ...
        function = new CECCambioNivelSeguridad() {
