...
import com.dc.jira.jira.workflow.CECAsignacionEspecialista;

public class CECAsignacionEspecialistaTest
{
    public static final String MESSAGE = "my message";

    protected CECAsignacionEspecialista function;
    ...
    public void setup() {
        ...
        function = new CECAsignacionEspecialista() {
