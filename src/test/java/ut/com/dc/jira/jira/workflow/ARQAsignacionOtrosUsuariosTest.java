...
import com.dc.jira.jira.workflow.ARQAsignacionOtrosUsuarios;

public class ARQAsignacionOtrosUsuariosTest
{
    public static final String MESSAGE = "my message";

    protected ARQAsignacionOtrosUsuarios function;
    ...
    public void setup() {
        ...
        function = new ARQAsignacionOtrosUsuarios() {
