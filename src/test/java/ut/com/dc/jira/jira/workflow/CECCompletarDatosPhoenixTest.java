...
import com.dc.jira.jira.workflow.CECCompletarDatosPhoenix;

public class CECCompletarDatosPhoenixTest
{
    public static final String MESSAGE = "my message";

    protected CECCompletarDatosPhoenix function;
    ...
    public void setup() {
        ...
        function = new CECCompletarDatosPhoenix() {
