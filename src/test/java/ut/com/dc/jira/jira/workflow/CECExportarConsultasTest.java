...
import com.dc.jira.jira.workflow.CECExportarConsultas;

public class CECExportarConsultasTest
{
    public static final String MESSAGE = "my message";

    protected CECExportarConsultas function;
    ...
    public void setup() {
        ...
        function = new CECExportarConsultas() {
