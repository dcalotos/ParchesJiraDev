...
import com.dc.jira.jira.workflow.GDVAsignacionValidador;

public class GDVAsignacionValidadorTest
{
    public static final String MESSAGE = "my message";

    protected GDVAsignacionValidador function;
    ...
    public void setup() {
        ...
        function = new GDVAsignacionValidador() {
