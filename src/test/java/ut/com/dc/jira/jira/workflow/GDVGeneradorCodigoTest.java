...
import com.dc.jira.jira.workflow.GDVGeneradorCodigo;

public class GDVGeneradorCodigoTest
{
    public static final String MESSAGE = "my message";

    protected GDVGeneradorCodigo function;
    ...
    public void setup() {
        ...
        function = new GDVGeneradorCodigo() {
